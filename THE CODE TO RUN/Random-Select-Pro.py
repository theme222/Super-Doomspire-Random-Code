...
# if you want it easy just run the other file
# made by theme222
...
extraeventlist = ['bomb only', 'no special abilities', "play on a different console than you're used to",
                  "every time you change weapons do the most annoying emote within 3 seconds",
...
wincondition = ['get 10 kills', 'win twice in a row', ' get more kills than bricks', 'get more than 200 bricks',
                'win in 4 minutes']
